...
daduhe_path = r"E:\GeoProjects\dry_hot_valley\valley_area\西南干旱河谷范围\Jinshajiang_valley.shp"  # 边界矢量
out_dir = r'E:\GeoProjects\dry_hot_valley\alley_analysis\Jinshajiang'
