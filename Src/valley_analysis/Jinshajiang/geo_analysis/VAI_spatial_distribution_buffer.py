...
输入:
  ...
  - 河道中心线 (centerline_final.shp, 筛选 Jinshajiang 特征)
输出:
...
# 0. Configuration
# ============================================================
NDVI_PATH = r"E:\GeoProjects\dry_hot_valley\valley_analysis\Jinshajiang\NDVI\Interannual\NDVI_interannual_mean_region.tif"
DIRECTION_PATH = r"E:\GeoProjects\dry_hot_valley\valley_analysis\Jinshajiang\geo_factor\windward_leeward_region.tif"
...
OUT_DIR = r"E:\GeoProjects\dry_hot_valley\valley_analysis\Jinshajiang\VAI"
...
if __name__ == "__main__":
    ...
    print(f"  filter Name = {JINSHAJIANG_NAME!r}")
    lines = load_centerline_lines(CENTERLINE_PATH, JINSHAJIANG_NAME, ref_crs)
