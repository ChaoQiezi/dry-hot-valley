...
in_dir = r'E:\GeoProjects\dry_hot_valley\Minjiang\Result\Table\altitude'
out_dir = r'E:\GeoProjects\dry_hot_valley\Minjiang\Result\Chart\altitude'
...
if __name__ == '__main__':
    wildcard = os.path.join(in_dir, '*elevation_gradient.xlsx')
    in_paths = glob(wildcard)
    for in_path in in_paths:
        out_path = os.path.join(out_dir, os.path.basename(in_path).replace('.xlsx', '.png'))
