...
"""
This script is used to 在岷江严格干热河谷polygon内部重算3km网格VAI

与既有 VAI_spatial_distribution.py(基于_region外接矩形)的差异:
  - 像素级空间约束: 仅使用落在 Minjiang_valley.shp polygon 内的 NDVI/迎背风像素
...
输入:
  ...
  - 严格河谷 polygon (Minjiang_valley.shp)
输出:
...
VALLEY_SHP_PATH = r"E:\GeoProjects\dry_hot_valley\valley_area\西南干旱河谷范围\Minjiang_valley.shp"
