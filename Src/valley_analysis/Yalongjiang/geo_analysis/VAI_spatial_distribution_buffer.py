...
"""
This script is used to 在雅砻江河道4km缓冲区内重算3km网格VAI
...
输入:
  ...
  - 河道中心线 (centerline_final.shp, 筛选 Yalongjiang 特征)
输出:
...
if __name__ == "__main__":
    ...
    print(f"  filter Name = {YALONGJIANG_NAME!r}")
    lines = load_centerline_lines(CENTERLINE_PATH, YALONGJIANG_NAME, ref_crs)
