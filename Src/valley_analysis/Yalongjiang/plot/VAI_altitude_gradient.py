...
# 0. Configuration
in_path = r'E:\GeoProjects\dry_hot_valley\valley_analysis\Yalongjiang\Result\Table\VAI_altitude_gradient.xlsx'
out_path = r'E:\GeoProjects\dry_hot_valley\valley_analysis\Yalongjiang\Result\Chart\VAI_altitude_gradient.png'
# 1. Read data
...
# )
# 坐标轴
ax_main.set_ylabel('雅砻江河谷VAI (%)', fontsize=12)
