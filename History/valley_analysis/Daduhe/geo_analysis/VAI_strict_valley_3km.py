...
"""
This script is used to 在大渡河严格干热河谷polygon内部重算3km网格VAI

与既有 VAI_spatial_distribution.py(基于_region外接矩形)的差异:
  - 像素级空间约束: 仅使用落在 Daduhe_valley.shp polygon 内的 NDVI/迎背风像素
...
输入:
  ...
  - 严格河谷 polygon (Daduhe_valley.shp)
输出:
...
# 0. Configuration
# ============================================================
NDVI_PATH = r"E:\GeoProjects\dry_hot_valley\Daduhe\NDVI\Interannual\NDVI_interannual_mean_region.tif"
...
VALLEY_SHP_PATH = r"E:\GeoProjects\dry_hot_valley\valley_area\西南干旱河谷范围\Daduhe_valley.shp"
