...
"""
Minjiang-only trial for Zhao's "elevation threshold / height difference" question.
...
VAI_PATH = BASE_DIR / "Minjiang" / "VAI" / "VAI_3km_region.tif"
DEM3_PATH = BASE_DIR / "Minjiang" / "VAI" / "DEM_3km_region.tif"
DEM10_PATH = BASE_DIR / "Minjiang" / "geo_factor" / "elevation_10m_projected_region.tif"
...
MINJIANG_CENTERLINE_NAME = "岷江干旱河谷"
...
def load_minjiang_centerline_samples():
    ...
    for sr in reader.iterShapeRecords():
        ...
        if rec.get("Name") != MINJIANG_CENTERLINE_NAME:
            continue
    ...
    if samples.empty:
        raise RuntimeError("No Minjiang centerline samples were found.")
    ...
    if samples.empty:
        raise RuntimeError("No valid 10 m DEM samples on Minjiang centerline.")
...
def plot_trial(abs_gradient, rel_gradient, threshold_summary, segment):
    ...
    fig.suptitle("岷江河道廊道VAI阈值试验", fontsize=13, y=0.985)
...
if __name__ == "__main__":
    print("=" * 72)
    print("Minjiang river-corridor VAI threshold trial")
    print("=" * 72)
