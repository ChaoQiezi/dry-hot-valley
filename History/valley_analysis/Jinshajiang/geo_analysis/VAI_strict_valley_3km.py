...
"""
This script is used to 在金沙江严格干热河谷polygon内部重算3km网格VAI

与既有 VAI_spatial_distribution.py(基于_region外接矩形)的差异:
  - 像素级空间约束: 仅使用落在 Jinshajiang_valley.shp polygon 内的 NDVI/迎背风像素
...
输入:
  ...
  - 严格河谷 polygon (Jinshajiang_valley.shp)
输出:
...
# 0. Configuration
# ============================================================
NDVI_PATH = r"E:\GeoProjects\dry_hot_valley\Jinshajiang\NDVI\Interannual\NDVI_interannual_mean_region.tif"
DIRECTION_PATH = r"E:\GeoProjects\dry_hot_valley\Jinshajiang\geo_factor\windward_leeward_region.tif"
DEM_PATH = r"E:\GeoProjects\dry_hot_valley\Jinshajiang\geo_factor\elevation_10m_projected_region.tif"
VALLEY_SHP_PATH = r"E:\GeoProjects\dry_hot_valley\valley_area\西南干旱河谷范围\Jinshajiang_valley.shp"

OUT_DIR = r"E:\GeoProjects\dry_hot_valley\Jinshajiang\VAI"
